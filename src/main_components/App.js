...
class LandingPage extends Component {
  ...
  render() {
    ...
    <div className="landing-page">
      <h1>Understanding Carbon Emissions</h1>
      <div className="images">
        <img src="/images/pollution.jpg" alt="co2" />
        <img src="/images/carbonEmissions.jpg" alt="carbonEmissions" />
        <img src="/images/reduceCarbon.png" alt="reduceCarbon" />
      </div>
      <p>Welcome to our website! Here you can learn about your carbon footprint and the impact of carbon emissions on our planet. <br></br>

Did you know that the average person's daily activities, such as driving a car, using electricity, and consuming goods and services, contribute to the release of greenhouse gases like carbon dioxide into the atmosphere? These emissions contribute to climate change and have negative impacts on the environment, including rising sea levels, more frequent and severe natural disasters, and harm to wildlife.

<br></br> 
<br></br>
But there is hope! By taking small steps to reduce your carbon footprint, you can make a positive impact on the environment. And what better time to start than the new year? Make a resolution to live more sustainably and reduce your carbon emissions. On our website, you can learn about simple changes you can make to your daily routine to reduce your carbon footprint, such as using public transportation, reducing energy consumption, and supporting clean energy.

<br></br> <br></br>
Together, we can all work towards a cleaner future. Thank you for visiting our website and we hope you find the information and tools you need to take action.</p>
     <h1>Take your New Year Pledge Now!</h1>
    </div>
  );
}
  ...
  //       <img src="/images/pollution.jpg" width="100%" alt=""></img><br />
